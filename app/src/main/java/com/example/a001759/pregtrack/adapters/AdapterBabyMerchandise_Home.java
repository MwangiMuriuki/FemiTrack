...
public class AdapterBabyMerchandise_Home extends RecyclerView.Adapter<AdapterBabyMerchandise_Home.MyViewHolder> {
    ...
    public AdapterBabyMerchandise_Home(List<ModelClassMerchandise> list, FirebaseFirestore firebaseFirestore, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterBabyMerchandise_Home.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterBabyMerchandise_Home.MyViewHolder holder, int position) {
