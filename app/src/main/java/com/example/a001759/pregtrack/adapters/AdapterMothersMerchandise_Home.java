...
public class AdapterMothersMerchandise_Home extends RecyclerView.Adapter<AdapterMothersMerchandise_Home.MyViewHolder> {
    ...
    public AdapterMothersMerchandise_Home(List<ModelClassMomMerch> list, FirebaseFirestore firebaseFirestore, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterMothersMerchandise_Home.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterMothersMerchandise_Home.MyViewHolder holder, int position) {
