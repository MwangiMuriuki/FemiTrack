...
import com.example.a001759.pregtrack.databinding.ActivityBabyDietBinding;
...
public class ActivityBabyDiet extends AppCompatActivity {
    ...
    ActivityBabyDietBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_baby_diet);
        binding.babysDietToolBar.setNavigationIcon(R.drawable.ic_back);
        setSupportActionBar(binding.babysDietToolBar);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Baby`s Diet");
        ...
        adapterOtherArticles = new AdapterOtherArticles(list, firebaseFirestore, ActivityBabyDiet.this);
        binding.recyclerView.setAdapter(adapterOtherArticles);

        firebaseFirestore.collection("babys_diet_articles").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
